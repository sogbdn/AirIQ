...
//     if (currentUser) {
  ...
  airRatingStrings = {
    AQI1 : "Breathe deep and travel far and wide. The air quality is excellent.",
    AQI2 : "Air quality is not ideal, but no need to modify outdoor activities. Sensitive individuals should take it easy if they experience any symptoms.",
    AQI3: "Mid-range pollutants present. A good day for indoor activities to limit outdoor exposure.",
    AQI4: "Take it easy and take shelter. Limit outdoor time or heavy exertion in favor of indoor playtime.",
    AQI5: "Significant health risks. Avoid prolonged outdoor exposure and reschedule if you are experiencing symptoms such as coughing or throat irritation.",
    AQI6: "Hazardous. Serious pollutant levels that may aggravate lung and heart. Reduce or reschedule activities, especially if you are experiencing symptoms. Everyone should avoid all outdoor exertion.",
    AQI_null: "Rating unavailable.",
    AQI1_medical: "Breathe deep and enjoy. A great day for outdoor adventure and stretching out the body.",
    AQI2_medical: "Acceptable air quality but sensitive individuals should observe symptoms such as coughing or throat irritation, and adjust activities as needed.",
    ...
    AQI5_medical: "Significant health risks. Avoid prolonged outdoor exposure and reschedule if you are experiencing symptoms such as coughing and throat irritation.",
    AQI1_lifestyle: "Breathe deep and plan for adventure. The air is primed for all outdoor activities.",
    AQI2_lifestyle: "Some pollutants may aggravate, but otherwise Oxygen and Potassium are 'OK'. Observe any symptoms and adjust exersion if needed.",
    AQI3_lifestyle: "Mid-range to heavier pollutants present. Air on the side of caution and reschedule any marathons or strenuous activity.",
    AQI4_lifestyle: "Serious Pollution levels present. Limit exposure and heavy exersion where possible to protect heart and lungs.",
