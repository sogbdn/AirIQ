...
export default class UserProfile extends Component {
	...
	componentDidMount() {
		...
		if (currentUser !== null) {
			axios.get(`http://localhost:3001/verifyUser?currentUser=${currentUser}`).then((res) => {
	...
	handleSubmit = (event) => {
		...
		axios
			.post('http://localhost:3001/changeNumber', {
							...
							<Card.Body>
								...
								<Table striped bordered>
									<tbody>
										<tr>
											<td>
												<div className="userprofileindex">Name:</div>
											</td>
											<td>
												<p>
										...
										<tr>
											<td>
												<div className="userprofileindex">Email:</div>
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<div>{this.state.bad_days}</div>
											</td>
										</tr>
										<tr>
											<td>
												<div className="userprofileindex">Health Concern Tier</div>
											</td>
											<td>{this.state.concern_type}</td>
										</tr>
									</tbody>
								</Table>
							</Card.Body>
